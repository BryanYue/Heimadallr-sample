...
public class LogWriter {
    ...
    public static void cleanObsolete() {
        HandlerThreadFactory.getWriteLogThreadHandler().post(new Runnable() {
            ...
            public void run() {
                ...
                File[] f = HeimadallrInternals.getLogFiles();
    ...
    public static void deleteAll() {
        synchronized (SAVE_DELETE_LOCK) {
            try {
                File[] files = HeimadallrInternals.getLogFiles();
    ...
    private static String save(String logFileName, String str) {
        ...
        try {
            File file = HeimadallrInternals.detectedBlockDirectory();
            ...
            writer.write(HeimadallrInfo.SEPARATOR);
            writer.write("**********************");
            writer.write(HeimadallrInfo.SEPARATOR);
    ...
    public static File generateTempZip(String filename) {
        return new File(HeimadallrInternals.getPath() + "/" + filename + ".zip");
    }
}
